        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Dashboard Sistem Prediksi Risiko Gangguan Jaringan</h4>
                    ...
                    <div class="col-md-4">
                      <div class="card bg-danger text-white">
                        <div class="card-body">
                          <div class="d-flex justify-content-between align-items-center">
                            <div>
                              <h5 class="font-weight-bold mb-2">Prediksi Risiko</h5>
                              <?php
                              ...
                              ?>
                              <h3 class="mb-0"><?= number_format($data['total']) ?></h3>
                              <small>Total prediksi penyulang</small>
                            </div>
                          ...
                          <div class="mt-3">
                            <a href="index.php?page=prediksi" class="text-white">
                              <small>Lihat Prediksi <i class="ti-arrow-right ml-1"></i></small>
                            </a>
                          </div>
                        </div>
                      </div>

                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form id="clusteringForm" action="index.php?controller=clustering&action=performClustering" method="post">
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form id="splitDataForm" action="index.php?controller=clustering&action=splitData" method="post">
                                                <div class="form-group">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <div>
                                                    <a href="index.php?controller=clustering&action=viewResults" class="btn btn-sm btn-info">Lihat Detail</a>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($clusterStats as $stat): ?>
                                                                <tr>
                                                                    <td>Cluster <?= $stat['cluster_label'] ?></td>
                                                                    <td><?= $stat['count'] ?></td>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <div>
                                                    <a href="index.php?controller=clustering&action=viewSplitData" class="btn btn-sm btn-info">Lihat Detail</a>
                                                    <a href="index.php?controller=clustering&action=exportSplitData" class="btn btn-sm btn-success">Export CSV</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <?php 
                                                    $no = 1;
                                                    $preview = array_slice($clusteringResults, 0, 10);
                                                    foreach ($preview as $result): 
                                                    ?>
                                                        <tr>
                                                            <td><?= $no++ ?></td>
                                                            <td><?= $result['tanggal'] ?></td>
                                                            <td><?= ucfirst($result['nama_objek']) ?></td>
                                                            <td><?= $result['nama_penyulang'] ?></td>
                                                            <td>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <?php 
                                                    $no = 1;
                                                    $preview = array_slice($splitDataResults, 0, 10);
                                                    foreach ($preview as $result): 
                                                    ?>
                                                        <tr>
                                                            <td><?= $no++ ?></td>
